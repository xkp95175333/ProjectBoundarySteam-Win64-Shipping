...
struct ULuminARSessionFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void StartLuminARSession(struct UObject* WorldContextObject, struct FLatentActionInfo LatentInfo, struct ULuminARSessionConfig* Configuration); // Function MagicLeapAR.LuminARSessionFunctionLibrary.StartLuminARSession // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xd4c1a0
};
...
struct ULuminARFrameFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool LuminARLineTrace(struct UObject* WorldContextObject, struct FVector2D ScreenPosition, struct TSet<enum class ELuminARLineTraceChannel> TraceChannels, struct TArray<struct FARTraceResult> OutHitResults); // Function MagicLeapAR.LuminARFrameFunctionLibrary.LuminARLineTrace // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xd4bf30
	enum class ELuminARTrackingState GetTrackingState(); // Function MagicLeapAR.LuminARFrameFunctionLibrary.GetTrackingState // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0xd4bee0
};
...
struct ULuminARImageTrackingFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct ULuminARCandidateImage* AddLuminRuntimeCandidateImageEx(struct UARSessionConfig* SessionConfig, struct UTexture2D* CandidateTexture, struct FString FriendlyName, float PhysicalWidth, bool bUseUnreliablePose, bool bImageIsStationary, enum class EMagicLeapImageTargetOrientation InAxisOrientation); // Function MagicLeapAR.LuminARImageTrackingFunctionLibrary.AddLuminRuntimeCandidateImageEx // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xd4bb60
	struct ULuminARCandidateImage* AddLuminRuntimeCandidateImage(struct UARSessionConfig* SessionConfig, struct UTexture2D* CandidateTexture, struct FString FriendlyName, float PhysicalWidth, bool bUseUnreliablePose, bool bImageIsStationary); // Function MagicLeapAR.LuminARImageTrackingFunctionLibrary.AddLuminRuntimeCandidateImage // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xd4b930
};
...
struct ULuminARLightEstimate : UARBasicLightEstimate {
	...
	struct TArray<float> GetAmbientIntensityNits(); // Function MagicLeapAR.LuminARLightEstimate.GetAmbientIntensityNits // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xd4bde0
};
...
struct ULuminARCandidateImage : UARCandidateImage {
	...
	bool GetUseUnreliablePose(); // Function MagicLeapAR.LuminARCandidateImage.GetUseUnreliablePose // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xd4bf10
	bool GetImageIsStationary(); // Function MagicLeapAR.LuminARCandidateImage.GetImageIsStationary // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xd4bec0
	enum class EMagicLeapImageTargetOrientation GetAxisOrientation(); // Function MagicLeapAR.LuminARCandidateImage.GetAxisOrientation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xd4bea0
};
